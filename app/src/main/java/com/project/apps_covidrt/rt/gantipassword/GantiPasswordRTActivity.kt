package com.project.apps_covidrt.rt.gantipassword
...
import kotlinx.android.synthetic.main.activity_ganti_password_r_t.*
import kotlinx.android.synthetic.main.activity_ganti_password_warga.*
import org.json.JSONObject
import java.util.HashMap

class GantiPasswordRTActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ganti_password_r_t)

        btn_gantirt_password.setOnClickListener(View.OnClickListener {
            jsonParse()
        })
    }
    ...
    fun jsonParse() {
        ...
        val mStringRequest = object : StringRequest(Request.Method.POST, url, Response.Listener { response ->
            ...
            override fun getBody(): ByteArray {
                ...
                params2["old_password"] = et_gantirt_password_lama.text.toString().trim()
                params2["new_password"] = et_gantirt_password_baru.text.toString().trim()
                params2["new_password_confirmation"] = et_gantirt_password_konfirm.text.toString().trim()
