...
class EditProfileWargaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_edit_simpan.setOnClickListener(View.OnClickListener {
            ...
            if(TextUtils.isEmpty(et_edit_email.getText().toString()) ||
                ...
                TextUtils.isEmpty(et_edit_kecamatan.getText().toString()) || TextUtils.isEmpty(et_edit_kelurahan.getText().toString()) ||
    ...
    fun jsonParse() {
        ...
        })
        {
            ...
            override fun getBody(): ByteArray {
                ...
                params2["kecamatan"] = et_edit_kecamatan.text.toString().trim()
                params2["kelurahan"] = et_edit_kelurahan.text.toString().trim()
    ...
    fun jsonParseGet() {
        ...
        val mStringRequest = object : JsonObjectRequest(Request.Method.GET, url,null, Response.Listener { response ->
            ...
            et_edit_kecamatan.setText(response.getString("kecamatan"))
            et_edit_kelurahan.setText(response.getString("kelurahan"))
